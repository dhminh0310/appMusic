<?php
	...
	if(strlen($_POST['idPlaylist']) > 0){
		...
		$query = "SELECT BaiHat.IdBaiHat, BaiHat.TenBaiHat, BaiHat.HinhBaiHat, BaiHat.CaSi, BaiHat.LinkBaiHat, BaiHat.LuotThich FROM `BaiHat` WHERE IdPlayList = '$idPlaylist'";
