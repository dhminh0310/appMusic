...
public class RecyclerViewPlayMusicAdapter extends RecyclerView.Adapter<RecyclerViewPlayMusicAdapter.ViewHolder> {

    private List<Song> listSong;
    private Context context;

    public RecyclerViewPlayMusicAdapter(List<Song> listSong, Context context) {
